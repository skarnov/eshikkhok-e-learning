<?php
class dev_user_management{
    var $thsClass = 'dev_user_management';
...
//            }
        ...
        function get_user_educations($param = null){
        
            $param['single'] = $param['single'] ? $param['single'] : false;
            global $devdb;

            $select = "SELECT ".($param['select_fields'] ? implode(", ",$param['select_fields'])." " : ' e_user_educations.* ');
            $from = "FROM e_user_educations ";
            
            $where = "WHERE 1 ";
            $conditions = "";

            $count_sql = "SELECT COUNT(pk_education_id) AS TOTAL ".$from.$where;

            $conditions .= sql_condition_maker($param);
        ...
        function get_user_trainings($param = null){
        
            $param['single'] = $param['single'] ? $param['single'] : false;
            global $devdb;

            $select = "SELECT ".($param['select_fields'] ? implode(", ",$param['select_fields'])." " : ' e_user_trainings.* ');
            $from = "FROM e_user_trainings ";
            
            $where = "WHERE 1 ";
            $conditions = "";

            $count_sql = "SELECT COUNT(pk_training_id) AS TOTAL ".$from.$where;
        ...
        function get_user_employments($param = null){
        
            $param['single'] = $param['single'] ? $param['single'] : false;
            global $devdb;

            $select = "SELECT ".($param['select_fields'] ? implode(", ",$param['select_fields'])." " : ' e_user_employments.* ');
            $from = "FROM e_user_employments ";
            
            $where = "WHERE 1 ";
            $conditions = "";

            $count_sql = "SELECT COUNT(pk_employment_id) AS TOTAL ".$from.$where;
        ...
        function get_user_skills($param = null){
        
            $param['single'] = $param['single'] ? $param['single'] : false;
            global $devdb;

            $select = "SELECT ".($param['select_fields'] ? implode(", ",$param['select_fields'])." " : ' e_user_skills.* ');
            $from = "FROM e_user_skills ";
            
            $where = "WHERE 1 ";
            $conditions = "";

            $count_sql = "SELECT COUNT(pk_skill_id) AS TOTAL ".$from.$where;
        ...
        function get_user_contact_info($param = null){
         
            $param['single'] = $param['single'] ? $param['single'] : false;
            global $devdb;

            $select = "SELECT ".($param['select_fields'] ? implode(", ",$param['select_fields'])." " : ' e_user_contacts.* ');
            $from = "FROM e_user_contacts ";
            
            $where = "WHERE 1 ";
            $conditions = "AND address_type='".$param['address_type']."'";
            $count_sql = "SELECT COUNT(pk_contact_id) AS TOTAL ".$from.$where;
        ...
        function get_social_info($param = null){
        
            $param['single'] = $param['single'] ? $param['single'] : false;
            global $devdb;

            $select = "SELECT ".($param['select_fields'] ? implode(", ",$param['select_fields'])." " : ' e_user_social_profiles.* ');
            $from = "FROM e_user_social_profiles LEFT JOIN dev_users On (dev_users.pk_user_id = e_user_social_profiles.fk_user_id) ";
            
            $where = "WHERE 1 ";
            $conditions = "";

            $count_sql = "SELECT COUNT(pk_profile_id) AS TOTAL ".$from.$where;
        ...
        function get_user_settings($param = null){
        
            $param['single'] = $param['single'] ? $param['single'] : false;
            global $devdb;

            $select = "SELECT ".($param['select_fields'] ? implode(", ",$param['select_fields'])." " : ' e_settings.* ');
            $from = "FROM e_settings ";
            
            $where = "WHERE 1 ";
            $conditions = "";

            $count_sql = "SELECT COUNT(pk_setting_id) AS TOTAL ".$from.$where;
