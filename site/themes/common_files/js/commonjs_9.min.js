/* F:/xampp/htdocs/E-SHIKKHOK/site/themes/common_files/js/jquery-3.3.1.min.js */
...
/* F:/xampp/htdocs/E-SHIKKHOK/site/themes/common_files/js/jquery-ui.min.js */
...
/* F:/xampp/htdocs/E-SHIKKHOK/site/themes/common_files/js/common.js */
    ...
    * */
            ...
            <div class="select2-info">\
                <div class="select2-container select2-container-multi form-control">\
                    <ul class="select2-choices">\
                        <li class="autocomplete_inputbox"><input type="text" id="'+ths.options.input_field_id+'" value="" /></li>\
                    </ul>\
                </div>\
            </div>\
            ');
    ...
    ths.generate_new_item = function(ui){
        ...
        if(ths.options.multilingual){
            ...
            ui.item.value = processToRender(ui.item.value, null, true);
            }
    ...
    ths.init = function(){
        ...
        ths.input_field.autocomplete({
            ...
            response: function(event, ui){
                if(ths.options.add_new){
                    if(!ui.content.filter(function(obj){return obj.value.toLowerCase() == ths.current_term.toLowerCase()}).length){
                        //console.log(ui.content.filter(function(obj){return obj.value.toLowerCase() == ths.current_term.toLowerCase()}));
                        ui.content.unshift({id: null, label: ths.current_term, value: ths.current_term});
                        }
                    ...
                    bootboxConfirm({
                        ...
                        'confirm': {
                            'callback': function(){
                                ...
                                dataForAdd[ths.options.field_for_add] = ths.options.multilingual ? processToRender(ui.item.label, null, true) : ui.item.label;
                                ...
                                $.ajax({
                                    ...
                                    success : function(ret){
                                        if(ret.success){
                                            ...
                                            ths.input_field.before(new_item);
                                            ths.input_field.val('');
        ...
        ths.input_field.data('ui-autocomplete')._renderItem = function (ul, item) {
            if(ths.options.multilingual){
                ...
                item.value = processToRender(item.value, null, true);
                }
            var html = '';
...
/* F:/xampp/htdocs/E-SHIKKHOK/site/themes/common_files/js/select2.full.min.js */
