...
//        'created_by' => $_config['user']['pk_user_id'],
    ...
    if ($ret['error']) {
        ...
        header('location: ' . url('instructorszone/new_module?course_id='.$course_id));
        exit();
    }
}
?>
    ...
    <div class="row">
        <div class="col-md-3 mt-5">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link active" href="new_module?id=<?php echo $course_id ?>">Create New Module</a>
            </div>
        </div>
