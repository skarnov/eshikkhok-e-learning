        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <h4 class="detail_content_price">Price: <?php echo handleEmptyStrings(getMetaValue($theContent, 'training_price'),'0'); ?> <?php echo ML('bdt'); ?></h4>
                    <hr />
                    ...
                    foreach($contents['data'] as $i=>$item){
                        ...
                        <div class="col-lg-4 each_service_container">
                            <div class="each_service">
                                ...
                                <h4 class="content_price"><a href="<?php echo $detailLink; ?>">Price: <?php echo handleEmptyStrings(getMetaValue($item,'training_price'),'0'); ?> <?php echo ML('BDT'); ?></a></h4>
